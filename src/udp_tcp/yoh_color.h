...
Irit Ofir the Greatest Proggrammer Alive
...
when you write the values do it without
the '    '


"color<text>RESET!"

printf("\033[0;35mThis text is Purple colord\033[0m\n")
...
#include <stdio.h>
 ...
 __inline__ void PrintColor(const char *color);
